...
elsewhere," stop here — do not start `/craft:do`'s own routing analysis.**
Otherwise proceed using the prompt the skill returns. On no-argument
interactive commands, refine AFTER the topic is captured.
