...
elsewhere," stop here — do not start architecture planning.** Otherwise
proceed using the prompt the skill returns. On no-argument interactive
commands, refine AFTER the topic is captured.
