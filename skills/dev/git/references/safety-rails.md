...
> when the user asks "is this safe?" or "what are the safety rails?".
> Moved here from `commands/git/docs/safety-rails.md` (now a thin shim)
> as part of the deprecated-command audit (issue #233).
