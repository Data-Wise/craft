...
> when the user says "I messed up", "how do I undo X", or has a git emergency.
> Moved here from `commands/git/docs/undo-guide.md` (now a thin shim) as part
> of the deprecated-command audit (issue #233).
