# Homebrew Tap Update Reference (Step 10)

Full implementation for Step 10: Update Homebrew Tap (formula and cask). See `SKILL.md` for the
one-line pointer; this file contains all shell code, configuration details, and sub-step
breakdowns.

## Table of Contents

- [Distribution Type Detection](#distribution-type-detection)
- [Step 10a: Update Formula](#step-10a-update-formula-existing-behavior)
- [Step 10b: Desktop App Cask Release (Tauri)](#step-10b-desktop-app-cask-release-tauri)
- [Step 10b Error Recovery](#step-10b-error-recovery-desktop-app)
