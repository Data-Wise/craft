# Downstream Verification Reference

Detailed implementation for Step 13: Verify Downstream Workflows and Steps 13.4–13.7.

## Step 13: Verify Downstream Workflows
...
## Step 13.4: Doc Coverage Gate

Before sweeping for drift, verify all commands shipped in this release have their doc surfaces. This check is performed by `pre-release-check.sh` (Step 2b already wired it in). If you skipped `pre-release-check.sh`, run manually:
