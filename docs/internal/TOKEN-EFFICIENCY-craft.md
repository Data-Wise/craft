...
It scans every `commands/**/*.md` with `deprecated: true`, finds its `replaced-by:` skill, and computes `command_lines / skill_lines`. Top of the list at threshold 2.0 (47 commands flagged):
