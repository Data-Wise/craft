...
**53 commands** · **39 skills** · **2 agents** · [Documentation](https://data-wise.github.io/craft/)
...
├─────────────────────────────────────────────────────────────┤
│                                                             │
│ 53 commands available across 10 categories                   │
│                                                             │
│ [Command listing...]                                        │
└─────────────────────────────────────────────────────────────┘
```
...
- **[Commands Overview](commands/overview.md)** - Explore all 53 commands
