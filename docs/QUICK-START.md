...
**115 commands** · **39 skills** · **8 agents** · [Documentation](https://data-wise.github.io/craft/)
...
├─────────────────────────────────────────────────────────────┤
│                                                             │
│ 115 commands available across 10 categories                   │
│                                                             │
│ [Command listing...]                                        │
└─────────────────────────────────────────────────────────────┘
```
...
- **[Commands Overview](commands/overview.md)** - Explore all 115 commands
