...
> Get started with craft in **under 2 minutes** - designed for quick wins and minimal cognitive load.
...
| Question | Answer |
|----------|--------|
| Where are my commands? | Run `/craft:hub` to see all 69 commands |
