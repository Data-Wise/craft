...
**Why it matters:** The hub is your home base. If you see the listing with 94 commands, Craft is working. The project type and branch are auto-detected.
...
**Why it matters:** With 94 commands, you never need to memorize anything. Browse by category and the hub shows you how to use each command.
