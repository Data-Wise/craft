...
I want to find the right Craft command for a task without memorizing all 107 commands.
...
2. **Browse categories**
   ...
   Why: Progressive disclosure keeps the list manageable instead of showing all 107 commands at once
