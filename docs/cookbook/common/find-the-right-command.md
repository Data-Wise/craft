...
I want to find the right Craft command for a task without memorizing all 67 commands.
...
2. **Browse categories**
   ...
   Why: Progressive disclosure keeps the list manageable instead of showing all 67 commands at once
