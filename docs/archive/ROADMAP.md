...
- **Cross-repo worktree coordination** — ✅ BUILT (v2.15.0+). Specs referencing multiple `~/projects/` paths trigger paired worktree creation with bidirectional ORCHESTRATE files. See [Multi-Repo Workflow Guide](../guide/multi-repo-workflow.md).
