...
> **TL;DR** (30 seconds)
>
> - **What:** Full-stack developer toolkit with 63 commands, 2 AI agents, and 39 auto-triggered skills
...
> Full-stack developer toolkit for Claude Code — 63 commands, 2 agents, 39 skills with smart orchestration and ADHD-friendly workflows

## Features

<div class="grid cards" markdown>

- :rocket:{ .lg .middle } **63 Commands**
...
!!! success "Quick Win: Try It Now"
    Run `/craft:hub` to see all 63 commands organized by category - takes 5 seconds and shows everything craft can do.
...
- :scroll:{ .lg .middle } **[API Reference - Commands](API-REFERENCE-COMMANDS.md)**
    ...
    Complete documentation for all 63 commands organized by category with parameters, usage examples, and output formats
...
- [All 63 Commands with Full Documentation](API-REFERENCE-COMMANDS.md)
...
- :scroll:{ .lg .middle } **[API Reference](API-REFERENCE-COMMANDS.md)**
    ...
    Complete documentation for all 63 commands
