...
> **TL;DR** (30 seconds)
>
> - **What:** Full-stack developer toolkit with 95 commands, 8 AI agents, and 45 auto-triggered skills
...
> Full-stack developer toolkit for Claude Code — 95 commands, 8 agents, 45 skills with smart orchestration and ADHD-friendly workflows

## Features

<div class="grid cards" markdown>

- :rocket:{ .lg .middle } **95 Commands**
...
!!! success "Quick Win: Try It Now"
    Run `/craft:hub` to see all 95 commands organized by category - takes 5 seconds and shows everything craft can do.
...
- :scroll:{ .lg .middle } **[API Reference - Commands](API-REFERENCE-COMMANDS.md)**
    ...
    Complete documentation for all 95 commands organized by category with parameters, usage examples, and output formats
...
- [All 95 Commands with Full Documentation](API-REFERENCE-COMMANDS.md)
...
- :scroll:{ .lg .middle } **[API Reference](API-REFERENCE-COMMANDS.md)**
    ...
    Complete documentation for all 95 commands
