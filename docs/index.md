...
> **TL;DR** (30 seconds)
>
> - **What:** Full-stack developer toolkit with 60 commands, 2 AI agents, and 39 auto-triggered skills
...
> Full-stack developer toolkit for Claude Code — 60 commands, 2 agents, 39 skills with smart orchestration and ADHD-friendly workflows

## Features

<div class="grid cards" markdown>

- :rocket:{ .lg .middle } **60 Commands**
...
!!! success "Quick Win: Try It Now"
    Run `/craft:hub` to see all 60 commands organized by category - takes 5 seconds and shows everything craft can do.
...
- :scroll:{ .lg .middle } **[API Reference - Commands](API-REFERENCE-COMMANDS.md)**
    ...
    Complete documentation for all 60 commands organized by category with parameters, usage examples, and output formats
...
- [All 60 Commands with Full Documentation](API-REFERENCE-COMMANDS.md)
...
- :scroll:{ .lg .middle } **[API Reference](API-REFERENCE-COMMANDS.md)**
    ...
    Complete documentation for all 60 commands
