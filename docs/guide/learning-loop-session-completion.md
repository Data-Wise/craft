...
- [/craft:finish Reference](../commands/finish.md) — Command reference (the body now lives in the `adhd-workflow` skill; see [ADR-002](../adr/ADR-002-done-command-skill-consolidation.md))
