...
**Dry-Run Support:** 27 of 106 commands support `--dry-run` / `-n` preview mode
...
27 of 106 commands support `--dry-run` / `-n` preview mode. **Target exceeded:** 57% of target commands vs 52% goal.
