...
> **TL;DR**: 41 skills auto-activate from conversation context (no command to memorize) and 2 specialized agents handle deep work. Browse by category below; use [`/craft:hub`](commands/hub.md) to discover commands.
