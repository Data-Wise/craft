    ...
    def generate_report(self, issues: List[Issue]) -> str:
        ...
        if errors:
            ...
            for i, issue in enumerate(errors, 1):
                ...
                if issue.fixable:
                    lines.append("   Fix: Ask Claude to sync + auto-fix CLAUDE.md (docs/claude-md skill)")
                lines.append("")
        ...
        if errors or warnings:
            lines.append("Next: Ask Claude to sync + auto-fix CLAUDE.md (docs/claude-md skill)")
        else:
