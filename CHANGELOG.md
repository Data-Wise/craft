...
- **`/craft:restore`** — new root command combining git-activity recap
  ...
  See [`docs/specs/SPEC-craft-restore-2026-07-17.md`](docs/specs/SPEC-craft-restore-2026-07-17.md)
  and [`docs/architecture/craft-restore-pipeline.md`](docs/architecture/craft-restore-pipeline.md).
...
- **Skill-ecosystem governance (Phase 0)** — policy-as-code under `governance/`: `RULES.yaml`
  ...
  [Skill-Ecosystem Governance](docs/guide/governance.md) and a new
  [Plugin Release Runbook](docs/guide/plugin-release-runbook.md).
