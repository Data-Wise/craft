...
[![Version](https://img.shields.io/badge/version-2.27.0-blue.svg)](https://github.com/Data-Wise/craft)
[![Documentation](https://img.shields.io/badge/docs-99%25%20complete-brightgreen.svg)](https://data-wise.github.io/craft/)

> **v2.26.0 - Mermaid MCP Validation Pipeline** 🚀
> **107 commands** | **26 skills** | **8 agents** | **109 core tests + ~1595 total**
> Mermaid validation engine, auto-fix, health scores, pre-commit hook, MCP integration, 35 new tests.
