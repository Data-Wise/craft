...
[![Version](https://img.shields.io/badge/version-2.17.0-blue.svg)](https://github.com/Data-Wise/craft)
[![Documentation](https://img.shields.io/badge/docs-99%25%20complete-brightgreen.svg)](https://data-wise.github.io/craft/)

> **v2.17.0 - Release Pipeline + Branch Guard v2** 🚀
> **108 commands** | **22 skills** | **8 agents** | **~1504 tests passing**
> End-to-end /release skill with dry-run, branch guard smart mode, 55 new tests.
...
- [Skills & Agents](https://data-wise.github.io/craft/guide/skills-agents/) (22 skills, 8 agents)
...
- 📖 **[Skills & Agents](docs/guide/skills-agents.md)** - 22 skills, 8 agents
