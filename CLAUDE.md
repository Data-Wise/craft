...
**94 commands** · **45 skills** · **8 agents** · [Docs](https://data-wise.github.io/craft/) · [GitHub](https://github.com/Data-Wise/craft)
...
| Directory | Purpose |
|-----------|---------|
| `commands/` | 94 commands (auto-discovered, one `.md` per command) |
